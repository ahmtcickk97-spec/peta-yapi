...
                    marginRight: '-10px' // scaleX'den doğan boşluğu kapatır
                  }}
                >
                  PETA
                </span>
...
            <span className={`mt-2 text-[8px] md:text-[10px] font-bold tracking-tight transition-colors duration-300 ${
