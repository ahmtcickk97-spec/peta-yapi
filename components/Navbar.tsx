  ...
  return (
    <nav className={`fixed w-full z-50 transition-all duration-500 ${isScrolled ? 'bg-white shadow-md py-3' : 'bg-transparent py-6'}`}>
      <div className="container mx-auto px-6 flex justify-between items-center">
        ...
        {/* SAĞ TARAF: SOSYAL VE CTA */}
        <div className="hidden md:flex items-center gap-5">
          <a 
            href="https://www.instagram.com/petainsaat" 
            target="_blank" 
            rel="noopener noreferrer"
            className={`${isScrolled ? 'text-[#001F3F]' : 'text-white'} hover:text-[#38BDF8] transition-colors`}
          >
          ...
          <a 
            ...
            target="_blank"
            className="bg-[#38BDF8] text-white px-6 py-2.5 rounded-full font-bold text-[10px] uppercase tracking-wider hover:bg-[#001F3F] transition-all shadow-lg active:scale-95"
          >
            Hemen Teklif Al
          </a>
        </div>
