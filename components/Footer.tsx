...
const Footer = () => {
  return (
    <footer className="bg-[#001F3F] text-white pt-24 pb-12">
      {/* Navbar'daki yeni hizalama: px-2 md:px-4 ve max-w-[95%] eklendi */}
      <div className="container mx-auto px-2 md:px-4 lg:max-w-[95%]">
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          
          <div className="space-y-8">
            {/* --- FOOTER LOGO: NAVBAR İLE TAM DİKEY HİZALANDI --- */}
            <div className="flex flex-col items-start">
              <div className="relative transition-transform hover:scale-105 duration-300">
                <Image 
                  ...
                  width={220} 
                  height={80} 
                  // h-[55px] ile Navbar logosuna yakın bir ölçek yakaladık
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a href="https://instagram.com/petainsaat" target="_blank" className="p-3 bg-white/5 rounded-xl hover:bg-[#38BDF8] hover:text-[#001F3F] transition-all">
