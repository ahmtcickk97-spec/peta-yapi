          ...
          <div className="space-y-6">
            <div className="flex flex-col items-start leading-none">
              <div className="flex items-center">
                <span className="text-2xl font-black text-white">PETA</span>
                <span className="ml-1 bg-white text-[#001F3F] px-2 py-1 text-2xl font-black rounded-sm">YAPI</span>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a 
                ...
                className="p-3 bg-white/5 rounded-xl hover:bg-[#38BDF8] transition duration-300"
              >
